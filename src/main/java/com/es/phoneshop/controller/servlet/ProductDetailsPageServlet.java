...
public class ProductDetailsPageServlet extends HttpServlet {
    ...
    private static final String ERROR_MESSAGE_PART_1 = "Product with code '";
    private static final String ERROR_MESSAGE_PART_2 = "' not found.";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute(ERROR_MESSAGE_ATTRIBUTE, ERROR_MESSAGE_PART_1 + productId + ERROR_MESSAGE_PART_2);
