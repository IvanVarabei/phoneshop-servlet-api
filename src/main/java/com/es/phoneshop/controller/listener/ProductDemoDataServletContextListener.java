...
//        priceHistory2.put(LocalDate.of(2016, 8, 11), BigDecimal.valueOf(1100));
        return List.of(
                new Product("Samsung", "Samsung Galaxy S", new BigDecimal(100), usd, 100, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S.jpg"),
                new Product("Samsung", "Samsung Galaxy S II", new BigDecimal(200), usd, 0, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20II.jpg"),
                new Product("Samsung", "Samsung Galaxy S III", new BigDecimal(300), usd, 5, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20III.jpg"),
                new Product("Apple", "Apple iPhone", new BigDecimal(200), usd, 10, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Apple/Apple%20iPhone.jpg"),
                new Product("Apple", "Apple iPhone 6", new BigDecimal(1000), usd, 30, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Apple/Apple%20iPhone%206.jpg"),
                new Product("HTC", "HTC EVO Shift 4G", new BigDecimal(320), usd, 3, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/HTC/HTC%20EVO%20Shift%204G.jpg"),
                new Product("Sony", "Sony Ericsson C901", new BigDecimal(420), usd, 30, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Sony/Sony%20Ericsson%20C901.jpg"),
                new Product("Sony", "Sony Xperia XZ", new BigDecimal(120), usd, 100, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Sony/Sony%20Xperia%20XZ.jpg"),
                new Product("Nokia", "Nokia 3310", new BigDecimal(70), usd, 100, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Nokia/Nokia%203310.jpg"),
                new Product("Palm", "Palm Pixi", new BigDecimal(170), usd, 30, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Palm/Palm%20Pixi.jpg"),
                new Product("Siemens", "Siemens C56", new BigDecimal(70), usd, 20, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Siemens/Siemens%20C56.jpg"),
                new Product("Siemens", "Siemens C61", new BigDecimal(80), usd, 30, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Siemens/Siemens%20C61.jpg"),
                new Product("Siemens", "Siemens SXG75", new BigDecimal(150), usd, 40, new LinkedHashMap<>(), "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Siemens/Siemens%20SXG75.jpg"));
    }

    private List<Product> getSampleProducts1() {
        Currency usd = Currency.getInstance("USD");
//        LinkedHashMap<LocalDate, BigDecimal> priceHistory1 = new LinkedHashMap<>(); //todo
//        priceHistory1.put(LocalDate.of(2017, 4, 23), BigDecimal.valueOf(150));
//        priceHistory1.put(LocalDate.of(2016, 9, 2), BigDecimal.valueOf(180));
