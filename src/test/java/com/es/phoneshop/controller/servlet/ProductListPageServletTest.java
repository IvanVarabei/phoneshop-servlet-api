...
public class ProductListPageServletTest {
    ...
    public void setup() throws ItemNotFoundException {
        ...
        when(productService.findProducts("", SortField.DEFAULT, SortOrder.DEFAULT))
                .thenReturn(List.of(product1, product2));
        when(productService.findProducts("", SortField.PRICE, SortOrder.ASC))
    ...
    public void testDoGetEmptySortFieldEmptySortOrder() throws ServletException, IOException {
        ...
        verify(request).setAttribute(eq("tags"), any());
    ...
    public void testDoPostProductNotFound() throws ItemNotFoundException, ServletException, IOException {
        when(productService.find(1L)).thenThrow(ItemNotFoundException.class);
